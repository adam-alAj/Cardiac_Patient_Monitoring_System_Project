...
Define exactly what the project will solve before implementing machine learning.

## Tasks

### 0.1 Define the problem

Formulate a clear educational machine-learning problem around cardiac-related data.

The project should be framed as classification and data analysis rather than medical diagnosis.

### 0.2 Define the Target

Identify the column that the model will predict.
...
### 0.3 Define the Features

Identify which columns will be used as model inputs.
...
### 0.4 Define the ML approach

The supervised task will be a classification problem.

The project will contain:

- A simple baseline classifier.
- At least one comparison classifier.

### 0.5 Define evaluation methodology
...
### 0.6 Define unsupervised analysis

Plan an additional analysis using:

- Clustering
- PCA or another covered dimensionality-reduction method

The exact technique will depend on the selected dataset and the techniques covered in the training.
...
- Dataset requirements are known.
- Target is identifiable.
- Candidate features are understood.
- Supervised-learning strategy is defined.
